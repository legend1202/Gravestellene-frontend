...
import { GraveyardItem, IProductItem } from "src/types/product";
...
export function useGetProduct(productId: string) {
  const currentProduct = {
    product: {
      ...
      reviews: [
        {
          ...
          name: "Jayvion Simon",
          postedAt: "2024-05-03T10:04:54.327Z",
          comment:
        ...
        },
        {
          id: "e99f09a7-dd88-49d5-b1c8-1daf80c2d7b2",
          name: "Lucian Obrien",
          postedAt: "2024-05-02T09:04:54.327Z",
          comment:
        ...
        },
        {
          ...
          name: "Deja Brady",
          postedAt: "2024-05-01T08:04:54.327Z",
          comment:
        ...
        },
        {
          ...
          name: "Harrison Stein",
          postedAt: "2024-04-30T07:04:54.327Z",
          comment:
        ...
        },
        {
          ...
          name: "Reece Chung",
          postedAt: "2024-04-29T06:04:54.327Z",
          comment:
        ...
        },
        {
          ...
          postedAt: "2024-04-28T05:04:54.327Z",
          comment:
        ...
        },
        {
          ...
          postedAt: "2024-04-27T04:04:54.327Z",
          comment:
        ...
        },
        {
          ...
          name: "Melanie Noble",
          postedAt: "2024-04-26T03:04:54.327Z",
          comment:
      ...
      sku: "WW75K5211YW/SV",
      createdAt: "2024-05-02T09:04:54.327Z",
      saleLabel: {
        enabled: false,
        content: "SALE",
      },
...
export function useCreateGraveyard(graveyard: GraveyardItem) {
  const URL = graveyard ? endpoints.graveyard.create : "";
