import{c9 as R,s as k,w as n,al as o,ca as _,r as N,am as w,an as z,j as v,ao as E,ap as F,cb as I}from"./index-tWxiFnGS.js";const K=["className","color","disableShrink","size","style","thickness","value","variant"];let l=r=>r,P,b,$,S;const a=44,U=R(P||(P=l`
  0% {
...
`)),B=r=>{const{classes:s,variant:e,color:t,disableShrink:d}=r,u={root:["root",e,`color${n(t)}`],svg:["svg"],circle:["circle",`circle${n(e)}`,d&&"circleDisableShrink"]};return F(u,I,s)},G=k("span",{name:"MuiCircularProgress",slot:"Root",overridesResolver:(r,s)=>{const{ownerState:e}=r;return[s.root,s[e.variant],s[`color${n(e.color)}`]]}})(({ownerState:r,theme:s})=>o({display:"inline-block"},r.variant==="determinate"&&{transition:s.transitions.create("transform")},r.color!=="inherit"&&{color:(s.vars||s).palette[r.color].main}),({ownerState:r})=>r.variant==="indeterminate"&&_($||($=l`
    ...
    `),W)),V=N.forwardRef(function(s,e){const t=w({props:s,name:"MuiCircularProgress"}),{className:d,color:u="primary",disableShrink:D=!1,size:p=40,style:j,thickness:i=3.6,value:m=0,variant:x="indeterminate"}=t,M=z(t,K),c=o({},t,{color:u,disableShrink:D,size:p,thickness:i,value:m,variant:x}),h=B(c),f={},g={},C={};if(x==="determinate"){const y=2*Math.PI*((a-i)/2);f.strokeDasharray=y.toFixed(3),C["aria-valuenow"]=Math.round(m),f.strokeDashoffset=`${((100-m)/100*y).toFixed(3)}px`,g.transform="rotate(-90deg)"}return v.jsx(G,o({className:E(h.root,d),style:o({width:p,height:p},g,j),ownerState:c,ref:e,role:"progressbar"},C,M,{children:v.jsx(L,{className:h.svg,ownerState:c,viewBox:`${a/2} ${a/2} ${a} ${a}`,children:v.jsx(T,{className:h.circle,style:f,ownerState:c,cx:a,cy:a,r:(a-i)/2,fill:"none",strokeWidth:i})})}))}),q=V;export{q as C};
