import{j as e,G as o,S as t,e as W,r as g,p as q,z as U,T as a,D as v,B as j,L as l,d,x as V,C as H}from"./index-_tg0Vjne.js";import{a as _}from"./graveyard-LvUjv0FH.js";import{S as r}from"./Skeleton-DE5mqhd_.js";import{u as $,F as J}from"./form-provider-tifhRCot.js";import"./image-SDlH-Y9m.js";import"./styles-GXLlqNmt.js";import{R as K}from"./Rating-L_4PWj4N.js";import{G as Q}from"./graveyard-details-carousel-E_TOhnhC.js";import{M as X}from"./markdown-jKfzBdon.js";import{C as Z}from"./Card-SUD4YaWI.js";function ee({...i}){return e.jsxs(o,{container:!0,spacing:8,...i,children:[e.jsx(o,{xs:12,md:6,lg:7,children:e.jsx(r,{sx:{paddingTop:"100%"}})}),e.jsx(o,{xs:12,md:6,lg:5,children:e.jsxs(t,{spacing:3,children:[e.jsx(r,{sx:{height:16,width:48}}),e.jsx(r,{sx:{height:16,width:80}}),e.jsx(r,{sx:{height:16,width:.5}}),e.jsx(r,{sx:{height:16,width:.75}}),e.jsx(r,{sx:{height:120}})]})}),e.jsx(o,{xs:12,children:e.jsx(t,{direction:"row",alignItems:"center",children:[...Array(3)].map((s,n)=>e.jsxs(t,{spacing:2,alignItems:"center",justifyContent:"center",sx:{width:1},children:[e.jsx(r,{variant:"circular",sx:{width:80,height:80}}),e.jsx(r,{sx:{height:16,width:160}}),e.jsx(r,{sx:{height:16,width:80}})]},n))})})]})}function se({items:i,product:s,onAddCart:n,onGotoStep:c,disabledActions:m,...u}){const p=W(),{id:h,name:I,sizes:S,price:k,coverUrl:T,colors:C,newLabel:y,available:f,saleLabel:D}=s,F=!!(i!=null&&i.length)&&i.map(x=>x.id).includes(h),b={id:h,name:I,coverUrl:T,available:f,price:k,colors:C[0],size:S[4],quantity:f<1?0:1},w=$({defaultValues:b}),{reset:G,watch:L,handleSubmit:O}=w,M=L();g.useEffect(()=>{s&&G(b)},[s]);const P=O(async x=>{try{F||n==null||n({...x,colors:[M.colors],subTotal:x.price*x.quantity}),c==null||c(0),p.push(q.product.checkout)}catch(B){console.error(B)}}),N=e.jsx(j,{sx:{typography:"h5"},children:"Contact me!"}),A=e.jsxs(t,{direction:"row",spacing:3,justifyContent:"center",children:[e.jsxs(l,{variant:"subtitle2",sx:{color:"text.secondary",display:"inline-flex",alignItems:"center"},children:[e.jsx(d,{icon:"mingcute:add-line",width:16,sx:{mr:1}}),"Facebook"]}),e.jsxs(l,{variant:"subtitle2",sx:{color:"text.secondary",display:"inline-flex",alignItems:"center"},children:[e.jsx(d,{icon:"solar:heart-bold",width:16,sx:{mr:1}}),"Twitter"]}),e.jsxs(l,{variant:"subtitle2",sx:{color:"text.secondary",display:"inline-flex",alignItems:"center"},children:[e.jsx(d,{icon:"solar:share-bold",width:16,sx:{mr:1}}),"Instagram"]})]}),E=e.jsxs(e.Fragment,{children:[e.jsx(j,{sx:{typography:"h5"},children:"Find More!"}),e.jsx(a,{variant:"body2",sx:{color:"text.secondary"},children:e.jsxs(l,{variant:"subtitle2",sx:{color:"text.secondary",display:"inline-flex",alignItems:"center"},children:[e.jsx(d,{icon:"mingcute:add-line",width:16,sx:{mr:1}}),"Map - You can see Google Map!"]})}),e.jsx(a,{variant:"body2",sx:{color:"text.secondary"},children:e.jsxs(l,{variant:"subtitle2",sx:{color:"text.secondary",display:"inline-flex",alignItems:"center"},children:[e.jsx(d,{icon:"mingcute:add-line",width:16,sx:{mr:1}}),"News - You can see the News!"]})}),e.jsx(a,{variant:"body2",sx:{color:"text.secondary"},children:e.jsxs(l,{variant:"subtitle2",sx:{color:"text.secondary",display:"inline-flex",alignItems:"center"},children:[e.jsx(d,{icon:"mingcute:add-line",width:16,sx:{mr:1}}),"Forecast - You can see the weekly forecast!"]})})]}),R=e.jsxs(e.Fragment,{children:[e.jsx(a,{variant:"body2",sx:{color:"text.secondary"},children:"Phone number: +1 234 5678 9012"}),e.jsx(a,{variant:"body2",sx:{color:"text.secondary"},children:"E-mail: sorokin@mail.co"}),e.jsx(a,{variant:"body2",sx:{color:"text.secondary"},children:"Address: Artists' tombs in an 1808 burial ground"})]}),z=e.jsxs(t,{direction:"row",alignItems:"center",sx:{color:"text.disabled",typography:"body2"},children:[e.jsx(K,{size:"small",value:5,precision:.1,readOnly:!0,sx:{mr:1}}),"Oslo, Norway"]}),Y=(y.enabled||D.enabled)&&e.jsx(t,{direction:"row",alignItems:"center",spacing:1,children:y.enabled&&e.jsx(U,{color:"info",children:y.content})});return e.jsx(J,{methods:w,onSubmit:P,children:e.jsxs(t,{spacing:3,sx:{pt:3},...u,children:[e.jsxs(t,{spacing:2,alignItems:"flex-start",children:[Y,e.jsx(a,{variant:"h5",children:"Graveyard Name"}),z,N,R]}),e.jsx(v,{sx:{borderStyle:"dashed"}}),E,e.jsx(v,{sx:{borderStyle:"dashed"}}),A]})})}function re({description:i}){const s=`
